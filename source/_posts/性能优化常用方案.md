...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/da1fb68d1f6f47ec846a030470708ad0~tplv-k3u1fbpfcp-zoom-1.image) CNAME（意为：别名）：在域名解析中，实际上解析出来的指定域名对应的IP地址，或者该域名的一个CNAME，然后再根据这个CNAME来查找对应的IP地址。
...
**图示：** ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c988d7d0a46545d4a3424b459cdb0b0b~tplv-k3u1fbpfcp-zoom-1.image) **代码实现：**

---
title: 面试题笔记——REACT篇(下)
date: 2022-04-10 11:03:54
---
![React面试题.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8249c3737e744bb8bd699a0268c9c844~tplv-k3u1fbpfcp-zoom-1.image)
...
实际上，diff 算法探讨的就是虚拟 DOM 树发生变化后，生成 DOM 树更新补丁的方式。它通过对比新旧两株虚拟 DOM 树的变更差异，将更新补丁作用于真实 DOM，以最小成本完成视图更新。 ![CgqCHl_qyouAAkb9AAB_cmWuZhc920_mh1609406106571.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ae13e9d4b4274628ae57eb6cbccab3f3~tplv-k3u1fbpfcp-zoom-1.image) 具体的流程如下：

-   真实的 DOM 首先会映射为虚拟 DOM；
-   当虚拟 DOM 发生变化后，就会根据差距计算生成 patch，这个 patch 是一个结构化的数据，内容包含了增加、更新、移除等；
-   根据 patch 去更新真实的 DOM，反馈到用户的界面上。

![CgqCHl_qypGAZPuGAADYrK9nkJY878_mh1609406162857.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7e2b8da6c6604d9b810669af643ed530~tplv-k3u1fbpfcp-zoom-1.image) 一个简单的例子：
...
![51612599334_.pic.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c724a92c1ca84e11a6b62403488b408e~tplv-k3u1fbpfcp-zoom-1.image)

-   服务端数据请求

![61612599340_.pic.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/616a8156ccb7454fb8855a5e46b755b1~tplv-k3u1fbpfcp-zoom-1.image) **2）html渲染** 服务端渲染是先向后端服务器请求数据，然后生成完整首屏 html返回给浏览器；而客户端渲染是等js代码下载、加载、解析完成后再请求数据渲染，等待的过程页面是什么都没有的，就是用户看到的白屏。就是服务端渲染不需要等待js代码下载完成并请求数据，就可以返回一个已有完整数据的首屏页面。

-   非ssr html渲染

![31612599269_.pic.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8517f63792754981862827c4ee8b250d~tplv-k3u1fbpfcp-zoom-1.image)

-   ssr html渲染

![41612599275_.pic.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/03db3a94571b4ce684e9d3b4ef82844f~tplv-k3u1fbpfcp-zoom-1.image)

---
title: 面试题笔记——JS篇(上)
date: 2021-06-20 10:11:19
---
![JavaScript面试题.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/902fcf3e6da84b7f85398e0c80caeaac~tplv-k3u1fbpfcp-zoom-1.image)
...
下面看一下**双精度数是如何保存**的： ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/17405e84de984f7f9e21422301bae002~tplv-k3u1fbpfcp-zoom-1.image)
...
最终，a、b、c分别被赋予了数组第0、1、2个索引位的值： ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e4d736e253dd4e65b91f286e58fca852~tplv-k3u1fbpfcp-zoom-1.image) 数组里的0、1、2索引位的元素值，精准地被映射到了左侧的第0、1、2个变量里去，这就是数组解构的工作模式。还可以通过给左侧变量数组设置空占位的方式，实现对数组中某几个元素的精准提取：
...
通过把中间位留空，可以顺利地把数组第一位和最后一位的值赋给 a、c 两个变量： ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cdeac34bdba64c23a8031ce88637c44c~tplv-k3u1fbpfcp-zoom-1.image)
...
这样就得到了 name 和 age 两个和 stu 平级的变量： ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fbf21ede550a4356a6c610cff81a8283~tplv-k3u1fbpfcp-zoom-1.image)
...
遍历方法的详细解释：[《细数JavaScript中那些遍历和循环》](https://link.juejin.cn?target=https%3A%2F%2Fcuggz.blog.csdn.net%2Farticle%2Fdetails%2F107649549 "https://cuggz.blog.csdn.net/article/details/107649549")
...
**特点：** JavaScript 对象是通过引用来传递的，创建的每个新对象实体中并没有一份属于自己的原型副本。当修改原型时，与之相关的对象也会继承这一改变。 ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fec3a0dade6f4118826b947a0b1a5931~tplv-k3u1fbpfcp-zoom-1.image)
